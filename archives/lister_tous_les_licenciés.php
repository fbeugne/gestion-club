...
$sql_from = "Licencies where ( (Dates.`Type` = 'Championnat' or Dates.`Type` = 'Amical') and Dates.`Dpct` = 0 and Dates.`Date` > '$annee1-08-01' and Dates.`Date` < '$annee2-08-01') ORDER BY Dates.`Date` ASC";
